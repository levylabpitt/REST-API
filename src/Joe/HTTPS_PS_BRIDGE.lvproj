...
<Project Type="Project" LVVersion="16008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="RequestVIs" Type="Folder">
			...
			<Item Name="PUT_req_PS.vi" Type="VI" URL="../Requests/PUT_req_PS.vi"/>
			<Item Name="POST_req_PS.vi" Type="VI" URL="../Requests/POST_req_PS.vi"/>
			<Item Name="GET_Req_PS.vi" Type="VI" URL="../Requests/GET_Req_PS.vi"/>
			<Item Name="HEAD_req_PS.vi" Type="VI" URL="../Requests/HEAD_req_PS.vi"/>
			<Item Name="POST_Multipart_req_PS.vi" Type="VI" URL="../Requests/POST_Multipart_req_PS.vi"/>
			<Item Name="PATCH_Multipart_req_PS.vi" Type="VI" URL="../Requests/PATCH_Multipart_req_PS.vi"/>
			<Item Name="PATCH_req_PS.vi" Type="VI" URL="../Requests/PATCH_req_PS.vi"/>
		</Item>
		...
		<Item Name="REST_req.vi" Type="VI" URL="../Requests/REST_req.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="multipart_Body_Binary.vi" Type="VI" URL="../Multipart/multipart_Body_Binary.vi"/>
		</Item>
